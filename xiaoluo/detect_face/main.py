    ...
    for dir_name in dirs:
        ...
        for image_name in subject_images_names:
            ...
            if face is not None:
                ...
                print("Not Found Face:"+image_path)
    cv2.waitKey(1)
...
subjects = ["xijinping", "wangbaoqiang","tongjinlv"]
...
#加载测试图像
test_img1 = cv2.imread("test_data/0.jpg")
...
def detect_face(img):
    ...
    cv2.imwrite("b.jpg",gray[y:y + w, x:x + h])
    return faces[0]
